 ...
 * @return void
 */
function oshimo_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'oshimo' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'oshimo' ) ),
		'header'   => array( 'label' => __( 'Headers', 'oshimo' ) ),
		'query'    => array( 'label' => __( 'Query', 'oshimo' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'oshimo' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'oshimo_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'oshimo_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'oshimo/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'oshimo_register_block_patterns', 9 );
